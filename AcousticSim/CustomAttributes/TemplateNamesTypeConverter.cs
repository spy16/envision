...
namespace AcousticSim.Blocks.CustomAttributes
{
    /// <summary>
    ...
    public class TemplateNamesTypeConverter : ListTypeConverter
    {
        ...
        {
            return new StandardValuesCollection(Utils.GetTypes("AcousticSim.SignalGeneration").Select(it => it.Name).ToArray());
        }
    }
}