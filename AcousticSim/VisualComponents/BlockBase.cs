...
namespace Envision.Blocks
{
    ...
    public abstract class BlockBase : GlobalizedObject
    {
        ...
        public EventDescription LastEvent { get; set; }
        ...
        /// </summary>
        public abstract String ProcessingType { get; }

        /// <summary>
        /// Execute the block
        /// </summary>
        public abstract void Execute(EventDescription e);
        ...
        {
            /// <summary>
            /// Generates signals/numeric values
            /// </summary>
            Source,
            /// <summary>
            /// Basic operational blocks such as Arithmetic and Logic blocks
            /// </summary>
            Basic,
            /// <summary>
            /// Plotting tools
        ...
        /// </summary>
        /// <returns></returns>
        public virtual BlockBase CloneWithLinks()
        {
        ...
        {
            return ProcessingType; // GetProcessingTypeName(ProcessingType);
        }
        ...
        public DiagramNet.Elements.DiagramBlock VisualElement
        {
            get;
            set;
        }
        ...
        public virtual void OpenAdditionalSettingsWindow()
        {
            // this can be overriden to provide specific
            // options specific to a particular block.
        }
