...
namespace Envision.Blocks
{
    ...
    public class BlockList : List<BlockBase>
    {
        ...
        private void ExecuteBlock(BlockBase block, EventDescription e)
        {
            block.Execute(e);
            if (block.Cascade)
            {
            ...
            {
                ExecuteBlock(node.ConnectingNode.Root, e);
            }
        }
    }
}
